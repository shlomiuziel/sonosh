...
- [`sonos play-url`](sonos-play-url.md) — stream YouTube, YouTube Music playlists, podcasts, radio, and other URLs through a Sonos-safe local proxy.
...
To start a fresh source, use [`sonos open`](sonos-open.md) (Spotify URI), [`sonos play-url`](sonos-play-url.md) (web audio), [`sonos play-uri`](sonos-play-uri.md) (exact URI), or [`sonos favorites open`](sonos-favorites.md).
